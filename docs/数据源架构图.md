...
### a-stock-data V3.8.0 主源体系（22 源 · 60 能力入口 · 12 层）
...
| 20 | 中证指数（V3.8）| ✅ | 指数成分/权重/两种口径 PE 与股息率 | 极低（零鉴权，忌高频重复下载）|
| 21 | 国证指数（V3.8）| ✅ | 最近公布的指数成分/权重（月末快照）| 极低（零鉴权）|
| 22 | 北交所官方（V3.8，备胎）| ✅ | 当前行情/五档/成交量额 | 极低（匿名 Cookie 会话，分页限速）|

**12 层结构**：L1 行情 / L2 研报 / L3 信号 / L4 资金面·筹码 / L5 新闻 / L6 基础数据 / L7 公告 / L8 打板 / L9 ETF期权 / L10 舆情互动 / L11 宏观（V3.7.0 新增）/ L12 指数（V3.8.0 新增：中证/国证成分·权重·估值 + 深交所交易日历）
