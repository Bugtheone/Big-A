...
> 标注：🔴=失效 / 🟡=部分可用 / ✅=正常
> 更新记录：东财全面恢复（fid 周期修复 + push2delay 回退）、地区板块缺口解决、adata 轻接入、WSL 代理层
...
flowchart TB
    ...
    subgraph BUS[数据层（项目内）]
        ...
        TOOLS[工具层<br/>intraday_snapshot / daily_report /<br/>sector_cross_check / stock_plates / verify_v360]
    end
...
| **地区板块当日涨幅** | ✅ **已解决**（东财地域 m:90+t:1 恢复：辽宁/陕西/四川领涨）|
