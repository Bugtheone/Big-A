...
# v1.2.1（2026-08-24 实战验证修正）：+ '小金属'——tushare 行业名 '小金属'（67只：稀土/锂/钼/钨等）
#   不含任何既有关键词，导致资源主线核心分支全部漏标（当日板块资金实证：钼+4.9亿/能源金属+4.8亿
#   均流入小金属分支）。注意：调用方取标签请用返回键 'mainline' 或便捷函数 is_mainline_stock()。
MAINLINE_KWS = [
    '半导体', '通信', '软件', 'IT设备', '电子', '元器件', '光学', '电气设备',
    '汽车整车', '汽车配件', '机械基件', '专用机械', '电脑设备', '互联网',
    '煤炭', '石油', '有色', '贵金属', '稀有金属', '小金属', '铜', '铝', '锌', '镍',
    '航天', '船舶', '航空', '国防军工',
]
